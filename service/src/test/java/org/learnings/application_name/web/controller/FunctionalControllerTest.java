...
class FunctionalControllerTest {
    ...
    void getAllResource1_whenResourcesExist() {
        ...
        FunctionalResource expectedResource =
        ...
        ResponseEntity<List<FunctionalResource>> allResource1 = controller.getAllResource1();
    ...
    void getResource1ByID_whenResourcesExist() {
        ...
        ResponseEntity<FunctionalResource> allResource1 = controller.getResource1ByID("f9734631-6833-4885-93c5-dd41679fc908");

        assertThat(allResource1.getStatusCode()).isEqualTo(OK);
        assertThat(allResource1.getBody()).isEqualTo(expectedResource);
    }
    ...
    void createResource1() {
        ...
        FunctionalController.CreateResource1RequestBody requestBody = new FunctionalController.CreateResource1RequestBody(
